...
{S5KGM1STOFILM_SENSOR_ID, SENSOR_DRVNAME_S5KGM1STOFILM_MIPI_RAW, S5KGM1STOFILM_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3L6OFILM_MIPI_RAW)
{S5K3L6OFILM_SENSOR_ID, SENSOR_DRVNAME_S5K3L6OFILM_MIPI_RAW, S5K3L6OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(OV02B10OFILM_MIPI_RAW)
{OV02B10OFILM_SENSOR_ID, SENSOR_DRVNAME_OV02B10OFILM_MIPI_RAW, OV02B10OFILM_MIPI_RAW_SensorInit},
#endif
...
{HI259OFILM_SENSOR_ID, SENSOR_DRVNAME_HI259OFILM_MIPI_RAW, HI259OFILM_MIPI_RAW_SensorInit},
#endif

//Main Camera
#if defined(IMX686SUNNY_MIPI_RAW)
{IMX686SUNNY_SENSOR_ID, SENSOR_DRVNAME_IMX686SUNNY_MIPI_RAW, IMX686SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(IMX682SUNNY_MIPI_RAW)
{IMX682SUNNY_SENSOR_ID, SENSOR_DRVNAME_IMX682SUNNY_MIPI_RAW, IMX682SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(OV48BSUNNY_MIPI_RAW)
{OV48BSUNNY_SENSOR_ID, SENSOR_DRVNAME_OV48BSUNNY_MIPI_RAW, OV48BSUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(OV48BOFILM_MIPI_RAW)
{OV48BOFILM_SENSOR_ID, SENSOR_DRVNAME_OV48BOFILM_MIPI_RAW, OV48BOFILM_MIPI_RAW_SensorInit},
#endif
#if defined(IMX582_MIPI_RAW)
{IMX582_SENSOR_ID, SENSOR_DRVNAME_IMX582_MIPI_RAW, IMX582_MIPI_RAW_SensorInit},
#endif
//Sub Camera
#if defined(S5K3T2SUNNY_MIPI_RAW)
{S5K3T2SUNNY_SENSOR_ID, SENSOR_DRVNAME_S5K3T2SUNNY_MIPI_RAW, S5K3T2SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3T2OFILM_MIPI_RAW)
{S5K3T2OFILM_SENSOR_ID, SENSOR_DRVNAME_S5K3T2OFILM_MIPI_RAW, S5K3T2OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(OV16A1QSUNNY_MIPI_RAW)
{OV16A1QSUNNY_SENSOR_ID, SENSOR_DRVNAME_OV16A1QSUNNY_MIPI_RAW, OV16A1QSUNNY_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(HI847SUNNY_MIPI_RAW)
{HI847SUNNY_SENSOR_ID, SENSOR_DRVNAME_HI847SUNNY_MIPI_RAW, HI847SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(HI847OFILM_MIPI_RAW)
{HI847OFILM_SENSOR_ID, SENSOR_DRVNAME_HI847OFILM_MIPI_RAW, HI847OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(OV02B1BOFILM_MIPI_RAW)
{OV02B1BOFILM_SENSOR_ID, SENSOR_DRVNAME_OV02B1BOFILM_MIPI_RAW, OV02B1BOFILM_MIPI_RAW_SensorInit},
#endif
//Sub2 Camera
#if defined(GC5035SUNNY_MIPI_RAW)
{GC5035SUNNY_SENSOR_ID, SENSOR_DRVNAME_GC5035SUNNY_MIPI_RAW, GC5035SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(GC5035OFILM_MIPI_RAW)
{GC5035OFILM_SENSOR_ID, SENSOR_DRVNAME_GC5035OFILM_MIPI_RAW, GC5035OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(S5K5E9SUNNY_MIPI_RAW)
{S5K5E9SUNNY_SENSOR_ID, SENSOR_DRVNAME_S5K5E9SUNNY_MIPI_RAW, S5K5E9SUNNY_MIPI_RAW_SensorInit},
#endif
//Main3 Camera
#if defined(S5K4H7SUNNY_MIPI_RAW)
{S5K4H7SUNNY_SENSOR_ID, SENSOR_DRVNAME_S5K4H7SUNNY_MIPI_RAW, S5K4H7SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(S5K4H7OFILM_MIPI_RAW)
{S5K4H7OFILM_SENSOR_ID, SENSOR_DRVNAME_S5K4H7OFILM_MIPI_RAW, S5K4H7OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(HI1337SUNNY_MIPI_RAW)
{HI1337SUNNY_SENSOR_ID, SENSOR_DRVNAME_HI1337SUNNY_MIPI_RAW, HI1337SUNNY_MIPI_RAW_SensorInit},
#endif
////////////////// XIAOMI END ///////////////////////////
