...
enum SENINF_CLK_IDX_SENINF_CK {
	SENINF_CLK_IDX_SENINF_CK_MIN_NUM
				= SENINF_CLK_IDX_SYS_MAX_NUM,
	SENINF_CLK_IDX_SENINF_CK
				= SENINF_CLK_IDX_SENINF_CK_MIN_NUM,
	SENINF_CLK_IDX_SENINF1_CK,
	SENINF_CLK_IDX_SENINF2_CK,
	SENINF_CLK_IDX_SENINF_CK_MAX_NUM
};

enum SENINF_CLK_IDX_SENINF_CK_FREQ {
	SENINF_CLK_IDX_SENINF_CK_FREQ_MIN_NUM
				= SENINF_CLK_IDX_SENINF_CK_MAX_NUM,
	SENINF_CLK_IDX_FREQ_TOP_MAINPLL_D4_D2
				= SENINF_CLK_IDX_SENINF_CK_FREQ_MIN_NUM,
	SENINF_CLK_IDX_FREQ_TOP_UNINPLL_D5,
	SENINF_CLK_IDX_SENINF_CK_FREQ_MAX_NUM
};

enum SENINF_CLK_IDX_TG {
	SENINF_CLK_IDX_TG_MIN_NUM = SENINF_CLK_IDX_SENINF_CK_FREQ_MAX_NUM,
...
#define SENINF_CLK_SENINF_CK_273    SENINF_CLK_IDX_FREQ_TOP_MAINPLL_D4_D2
#define SENINF_CLK_SENINF_CK_499    SENINF_CLK_IDX_FREQ_TOP_UNINPLL_D5
