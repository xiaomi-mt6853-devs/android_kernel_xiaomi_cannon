...
/*
 *Get test data by read proc fs instead of
 *save test data in fs directly via kernel driver.
 *1: read data from proc(default)
 *0: save data directly
 */
#define FTS_PROC_GET_TESTDATA_EN			 1
